    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
            ...
            try:
                ...
                await bot.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("📢 HELLO FIRST CLICK HERE AND JOIN THE CHANNEL AND TRY AGAIN 📢", url=invite_link.invite_link)
                            ],
                            [
        ...
        await bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("📢 HELLO FIRST CLICK HERE AND JOIN THE CHANNEL AND TRY AGAIN 📢"
